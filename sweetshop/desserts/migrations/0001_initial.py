    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(verbose_name='Цена')),
                ('pub_date', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('decoration', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='desserts.cupcakedecoration', verbose_name='Оформление')),
                ('filling', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='desserts.cupcakefilling', verbose_name='Начинка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(verbose_name='Цена')),
                ('pub_date', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('decoration', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='desserts.cakedecoration', verbose_name='Оформление')),
                ('filling', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='desserts.cakefilling', verbose_name='Начинка')),
            ],
            options={
                'verbose_name': 'Торт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.IntegerField(verbose_name='Цена')),
                ('pub_date', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('filling', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='desserts.bentofilling', verbose_name='Начинка')),
            ],
            options={
